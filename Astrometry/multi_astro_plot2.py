...
fits1 = r'C:\PhD\Comet_data\Comet_McNaught_C2006P1\Gallery\Earth\c2006p1_2007_01_21_0058_Deiries.fits'
fits1t = r'C:\PhD\Comet_data\Comet_McNaught_C2006P1\Gallery\Earth\temporary_c2006p1_2007_01_21_0058_Deiries.fits'
fits2 = r'C:\PhD\Comet_data\Comet_McNaught_C2006P1\Gallery\Stereo_A\HI-1-diff\20070121_000100_s4h1A_diff.fits'
fits3 = r'C:\PhD\Comet_data\Comet_McNaught_C2006P1\Gallery\Stereo_A\HI-2-diff\20070121_000100_s4h2A_diff.fits'

threedimg1 = fits.open(fits1)
colours1 = np.nan_to_num(threedimg1[0].data)
onedimg1 = fits.open(fits1t)
try:
    w1 = wcs.WCS(onedimg1[0].header, key = 'A', naxis=2)
except:
    w1 = wcs.WCS(onedimg1[0].header, naxis=2)

colours1d = colours1[0,...]

#make a 2xN array of all pixel locations
ya1 = colours1d.shape[0]
xa1 = colours1d.shape[1]
...
colplot2 = np.clip( np.clip(255.0/(hih2-low2)*(colours2-low3),0,255).astype(int),0,255)
colplot3 = np.clip(np.clip(255.0/(hih3-low3)*(colours3-low3),0,255).astype(int),0,255)

imagemask1 = np.ones_like(colours1d)[:-1,:-1]
...
imagemask3 = (maskfits[0].data[::2,::2])[:-1,:-1]
...
for xp in range(0,no_points1):
    x = non_zeros_01[xp]
    y = non_zeros_11[xp]
    plotpixel2(d,x,y,rp1,dp1,colours1[0,x,y],colours1[1,x,y],colours1[2,x,y])
...
comimg.show()
comimg.save(r'C:\PhD\Comet_data\Comet_McNaught_C2006P1\21st_0100_obs.png','png')
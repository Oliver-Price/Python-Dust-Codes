...
png_location = r"C:\PhD\Comet_data\Comet_PanSTARRS_C2011L4\Gallery\Stereo_B\Badastrometry\pngs"
save_loc = r"C:\PhD\Comet_data\Comet_PanSTARRS_C2011L4\Gallery\Stereo_B\calibrated pngs"
...
for image_no in xrange(186,len(png_list)):

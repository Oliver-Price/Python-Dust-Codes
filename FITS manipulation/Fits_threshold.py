...
fits_thresh_folder = r"C:\PhD\Comet_data\Comet_McNaught_C2006P1\Gallery\Stereo_A\HI-1"
fits_wcs_folder = r"C:\PhD\Comet_data\Comet_McNaught_C2006P1\Gallery\Stereo_A\HI-1"

fits_out_folder = os.path.join(fits_wcs_folder,'thresholded_test')
...
# 
coeff = 0.97 #0.97 stereo a hi-1, 0.92 soho

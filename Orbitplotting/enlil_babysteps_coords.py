...
[f_r_hore,f_theta_hore,f_phi_hore] = xyz2rcolatlon(csv[:,1],csv[:,2],csv[:,3])
...
f_phi_hae = get_lambda(f_L,f_g)-180
f_theta_hae = np.full_like(f_phi_hae,90)
f_r_hae = np.full_like(f_phi_hae,1)

f_lamb = get_lambda(f_L,f_g)
f_omega = get_omega(f_t)
f_bigtheta = get_theta(f_lamb,f_omega)

[f_x_hae,f_y_hae,f_z_hae] = rcolatlon2xyz(f_r_hae,f_theta_hae,f_phi_hae)
[f_x_heeq,f_y_heeq,f_z_heeq] = hae2heeq(f_x_hae,f_y_hae,f_z_hae,f_bigtheta,f_omega)
[f_r_heeq,f_theta_heeq,f_phi_heeq] = xyz2rcolatlon(f_x_heeq,f_y_heeq,f_z_heeq)
...
[b_r_heeq,b_theta_heeq,b_phi_heeq] = xyz2rcolatlon(b_x_heeq,b_y_heeq,b_z_heeq)
[b_x_hae,b_y_hae,b_z_hae] = heeq2hae(b_x_heeq,b_y_heeq,b_z_heeq,b_bigtheta,b_omega)
[b_r_hae,b_theta_hae,b_phi_hae] = xyz2rcolatlon(b_x_hae,b_y_hae,b_z_hae)
...
[b_x_hae1,b_y_hae1,b_z_hae1] =  rcolatlon2xyz(b_r_hae,b_theta_hae,b_phi_hae)
